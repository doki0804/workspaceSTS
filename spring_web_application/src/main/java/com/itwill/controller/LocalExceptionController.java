...
public class LocalExceptionController {
	...
	public String businessmethod1() throws BusinessException1 {
		boolean b=true;
		
		if(b) {
			throw new BusinessException1("업무예외1발생");
		}
		return "business result1";
	}
	
	@GetMapping("/business2")
	public String businessmethod2() throws BusinessException2 {
		boolean b=true;
		
		if(b) {
			throw new BusinessException2("업무예외2발생");
		}
		return "business result2";
	}
	
	@GetMapping("/business3")
	public String businessmethod3(){
		String name=null;
		int length=name.length();
		return "business result3";
	}
