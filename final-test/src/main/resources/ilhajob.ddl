...
drop sequence app_id_seq_gen
drop sequence awards_id_seq_gen
drop sequence blog_id_seq_gen
drop sequence blog_comment_id_seq_gen
drop sequence bookmark_id_seq_gen
drop sequence corp_id_seq_gen
drop sequence corp_image_id_seq_gen
drop sequence corp_tag_id_seq_gen
drop sequence cv_id_seq_gen
drop sequence edu_id_seq_gen
drop sequence exp_id_seq_gen
drop sequence manager_id_seq_gen
drop sequence message_id_seq_gen
drop sequence orders_id_seq_gen
drop sequence payment_id_seq_gen
drop sequence product_id_seq_gen
drop sequence recruit_id_seq_gen
drop sequence recruit_tag_id_seq_gen
drop sequence review_id_seq_gen
drop sequence tag_id_seq_gen
drop sequence user_id_seq_gen

create sequence app_id_seq_gen start with 1 increment by  1
create sequence awards_id_seq_gen start with 1 increment by  1
create sequence blog_id_seq_gen start with 1 increment by  1
create sequence blog_comment_id_seq_gen start with 1 increment by  1
create sequence bookmark_id_seq_gen start with 1 increment by  1
create sequence corp_id_seq_gen start with 1 increment by  1
create sequence corp_image_id_seq_gen start with 1 increment by  1
create sequence corp_tag_id_seq_gen start with 1 increment by  1
create sequence cv_id_seq_gen start with 1 increment by  1
create sequence edu_id_seq_gen start with 1 increment by  1
create sequence exp_id_seq_gen start with 1 increment by  1
create sequence manager_id_seq_gen start with 1 increment by  1
create sequence message_id_seq_gen start with 1 increment by  1
create sequence orders_id_seq_gen start with 1 increment by  1
create sequence payment_id_seq_gen start with 1 increment by  1
create sequence product_id_seq_gen start with 1 increment by  1
create sequence recruit_id_seq_gen start with 1 increment by  1
create sequence recruit_tag_id_seq_gen start with 1 increment by  1
create sequence review_id_seq_gen start with 1 increment by  1
create sequence tag_id_seq_gen start with 1 increment by  1
create sequence user_id_seq_gen start with 1 increment by  1
    
    create table app (
       id number(19,0) not null,
        app_status char(1 char) not null,
        corp_id number(19,0),
        cv_id number(19,0),
    ...
    create table awards (
       id number(19,0) not null,
        awards_content varchar2(255 char),
        awards_date timestamp,
        awards_name varchar2(255 char),
        user_id number(19,0),
        primary key (id)
    )
    ...
    create table blog_comment (
       id number(19,0) not null,
        comment_content varchar2(255 char),
    ...
    create table corp (
       id number(19,0) not null,
        corp_address varchar2(255 char),
        corp_business_no varchar2(255 char),
        corp_comment varchar2(255 char),
        corp_est timestamp,
        corp_name varchar2(255 char),
        corp_password varchar2(255 char),
        ...
        corp_welfare varchar2(255 char),
    ...
    create table cv (
       id number(19,0) not null,
        cv_description varchar2(255 char),
        cv_name varchar2(255 char),
    ...
    create table edu (
       id number(19,0) not null,
        edu_content varchar2(255 char),
        edu_end_date timestamp,
        edu_major varchar2(255 char),
        edu_name varchar2(255 char),
        edu_score varchar2(255 char),
        edu_start_date timestamp,
        user_id number(19,0),
        primary key (id)
    )
    ...
    create table exp (
       id number(19,0) not null,
        exp_content varchar2(255 char),
        exp_corp_name varchar2(255 char),
        exp_end_date timestamp,
        exp_position varchar2(255 char),
    ...
    create table message (
       id number(19,0) not null,
        message_contents varchar2(255 char),
    ...
    create table review (
       id number(19,0) not null,
        review_content varchar2(255 char),
        review_grade varchar2(255 char),
        review_title varchar2(255 char),
        corp_id number(19,0),
        user_id number(19,0),
        primary key (id)
    )
